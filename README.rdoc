...
Geolocation data can be downloaded for free from geonames' {gazetteer data download page}[http://download.geonames.org/export/dump/]. For Gnlookup to work, you will need at least three files:
  countryInfo.txt
