...
You will also need to download free US zipcode data from the geonames {zipcode data download page}[http://download.geonames.org/export/zip/]. You will need this file:
  US.zip
